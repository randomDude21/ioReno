...
<div id="head_contact" class="jumbotron jumbotron-sm">
    <h1 style="opacity:1.0;">Contact</h1>
</div>
<div class="container">
    <div class="row">
        <div class="col-md-8">
        ...
        <div class="col-md-4">
            ...
            <address>
                <strong>IOReno</strong><br>
                735 Centre Bell, Suite 600<br>
                Montreal, QC J4L03D<br>
                <p title="Phone">
                    Phone: (123) 456-7890</p>
            </address>
            <address>
                <strong>Yves Brian</strong><br>
                <a href="mailto:yves1939@yahoo.ca">yves1939@yahoo.ca</a>
            </address>
            </form>
        </div>
    </div>
