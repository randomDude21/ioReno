                ...
                <fieldset>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <label for="email">E-mail</label>
                                ...
                                <span name="emailErr"><?php if (isset($_SESSION['emailErr'])) echo("{$_SESSION['emailErr']}"); $_SESSION['emailErr'] = ""; ?></span>
                                <span name="emailErr2"><?php if (isset($_SESSION['emailErr2'])) echo("{$_SESSION['emailErr2']}"); $_SESSION['emailErr2'] = ""; ?></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            ...
                            <span name="phoneErr"><?php if (isset($_SESSION['phoneErr'])) echo("{$_SESSION['phoneErr']}"); $_SESSION['phoneErr'] = ""; ?></span>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <span name="passErr"><?php if (isset($_SESSION['passErr'])) echo("{$_SESSION['passErr']}"); $_SESSION['passErr'] = ""; ?></span>
